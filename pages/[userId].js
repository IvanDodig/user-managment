...
import { email, required } from "../constants/formValidationRules";
...
const Edit = ({ data, permissions }) => {
  ...
  useEffect(() => {
    ...
    notification.error({
      message: `Error`,
      description: "Error happened while fetching user data",
      placement: "top",
    });
    router.push("/");
  }, []);
  ...
  return (
    <div>
      ...
      <Form
        ...
        <Row>
          <FormItem name="firstName" rules={[required]}>
